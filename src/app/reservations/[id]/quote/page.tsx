...
import { formatDateTimeWithLocale, getDiffDays } from "@/app/utils/timeUtils";
...
const ReservationDetailPage = () => {
  ...
  return (
    <div>
      ...
      />
      <FormWrapper maxWidth="1024px" width="1024px" isLoading={isLoading}>
        <Margin top={40} />
        ...
        <table className={styles.contractTable}>
          <tbody>
            ...
            <tr>
              ...
              <td colSpan={4}>
                반납 예정: {formatDateTimeWithLocale(reservationDetail.endDate)}
              </td>
              ...
              const listInfo = set.equipmentList.map((item, index) => {
                return (
                  ...
                  >
                    ...
                    <td colSpan={2}>수량: {item.quantity}</td>
                  </tr>
                );
              });
        ...
        <div className={styles.agreementSection}>
          ...
          <ul className={styles.ulWrapper}>
            ...
            <li>
              ...
              <ul className={styles.ulWrapper}>
                <li>
                  장비 확인, 작동 이상유무 확인, 테스트 촬영을 하지 않았을 경우
                  본 촬영의 문제 발생에 대해 책임지지 않습니다.
                </li>
                <li>
